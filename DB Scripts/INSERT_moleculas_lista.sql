...
No es un elemento combustible debido a que es un producto residual de la combustión del hidrógeno.','Las principales propiedades del agua (H2O) son:

Densidad: 1 g/cm3.
Masa Molar: 18,01528 g/mol.
Punto de fusión: 0,0 °C.
Punto de ebullición: 99,98 °C.','Los usos principales del agua se encuentran de las siguientes formas:
...
Temperatura de ignición: 605°C.','¿Dónde se encuentra el monóxido de carbono?
...
2 átomos de potasio.
1 átomo de oxígeno.','Las principales propiedades del óxido de potasio (K2O) son:

Densidad: 2,35 g/cm3.
Masa molar: 94,20 g/mol.
...
2 átomos de cobre.
1 átomo de oxígeno.','Las principales propiedades del óxido cuproso (Cu2O) son:

Densidad: 6,0 g/cm3.
Masa molar: 143,09 g/mol.
Punto de fusión: 1235 °C.
Punto de ebullición: 1800 °C.','El óxido de cobre (I) es un semiconductor utilizado para la realización de diversas aplicaciones como por ejemplo:
...
2 átomos de hierro.
3 átomos de oxígeno.','Las principales propiedades del óxido férrico (Fe2O3) son:

Densidad: 5,242 g/cm3.
Masa molar: 159,07 g/mol.
Punto de fusión: 1565 °C.
Solubilidad en agua: insoluble.','Entre las características más importantes del óxido de hierro (III) se encuentran:
...
1 átomo de hierro.
1 átomo de oxígeno.','Las principales propiedades del óxido ferroso (FeO) son:

Densidad: 5,745 g/cm3.
Masa molar: 71,844 g/mol.
Punto de fusión: 1377 °C.
Punto de ebullición: 3414 °C.','Entre las usos más característicos del óxido de hierro (II) se encuentran:
...
Solubilidad: 0,012g en 100g de agua','Dada su estructura dura y cristalina el óxido de silicio se utiliza para:
...
1 átomo de potasio.
1 átomo de hidrógeno.','Las principales propiedades del hidruro de potasio (KH) son:
...
1 átomo de oxígeno.','Las principales propiedades del anhídrido hiponitroso (N2O) son:

Presión crítica: 72,6 bar
Masa molar: 44,013 g/mol
Punto de ebullición: -89,5 °C
Densidad del gas (20ºC, 1 bar): 1843 g/ml','Entre las principales aplicaciones del anhídrido hiponitroso se encuentran:
...
Es un compuesto potencialmente peligroso y muy reactivo al disolverse en cloroformo.','Las principales propiedades del pentaóxido de dinitrógeno (N2O5) son:
...
El cloruro de hidrógeno es un compuesto tóxico, corrosivo, con un fuerte olor picante. En estado de humedad es capaz de producir vapores de ácidos que atacan a los metales menos al oro, plata, tantalio y platino.','Las principales propiedades del cloruro de hidrógeno son:

Densidad: 0,118 g/cm3.
Masa Molar: 36,46 g/mol.
Punto de fusión: -114,8 °C.
Punto de ebullición: -85 °C.','El cloruro de hidrógeno se usa entre otros usos en:
...
1 átomo de flúor.
El fluoruro de hidrógeno genera gases muy fuertes y es fácilmente disoluble en agua en sus diversos estados, ya sea gas o líquido. En su estado líquido el fluoruro de hidrógeno recibe el nombre de ácido fluorhídrico utilizado. El fluoruro de hidrógeno se obtiene por acción del ácido sulfúrico sobre el fluoruro de calcio.','Las principales propiedades del fluoruro de hidrógeno (HF) son:

Densidad: 0,118 g/cm3.
Masa Molar: 20,01 g/mol.
Punto de fusión: -83,55 °C.
Punto de ebullición: 19,51 °C.','Entre los usos comerciales que tiene el fluoruro de hidrógeno se encuentran la elaboración de:
...
1 átomo de potasio.
1 átomo de cloro.','Las propiedades más características del cloruro potásico (KCl) son:

Masa molar: 74,55 g/mol.
Densidad: 1987 g/cm3.
Punto de fusión: 776 ºC.
Punto de ebullición: 1497 ºC.','Entre las principales aplicaciones del monocloruro de potasio se encuentran:
...
Temperatura crítica: -93 °C.
Presión crítica: 63,16 atm.','Entre los principales usos monóxido de nitrógeno se encuentran:
...
Punto de ebullición: 1413°C.','Entre los usos del cloruro de sodio se encuentran:
...
Punto de ebullición: -162 °C.','Entre los principales usos del metano se encuentran:
...
En disolución acuosa se comporta como una base formando el ion amonio NH4+. El amoníaco a temperatura ambiente es un gas incoloro que presenta un fuerte olor. Su formación ocurre naturalmente por descomposición de materia orgánica e industrial: N2(g) + 3 H2(g) » 2 NH3(g).','Las principales propiedades del amoníaco(NH3) son:

Densidad: 0,73 kg/m3.
Masa Molar: 17,031 g/mol.
Punto de fusión: -77,73 °C.
Punto de ebullición: -33,34 °C.','Entre los principales funciones y usos del amoníaco se encuentran:
...
Punto de ebullición: -60,7 °C.','Entre las aplicaciones en las que interviene el ácido sulfhídrico se encuentran:
...
1 átomo de potasio.
1 átomo de oxígeno.
1 átomo de hidrógeno.','Las principales propiedades del hidróxido potásico (KOH) son:

Densidad: 2,04 g/cm3.
Masa molar: 56,105 g/mol.
Punto de fusión: 380 °C.
Punto de ebullición: 1323 °C.','Entre las aplicaciones en las que interviene el hidróxido de potasio se encuentran:
...
1 átomo de calcio.
2 átomos de oxígeno.
2 átomos de hidrógeno.','Las principales propiedades del hidróxido cálcico Ca(OH)2 son:

Densidad: 2,211 g/cm3.
Masa molar: 74,092 g/mol.
Punto de fusión: 550 °C.
Punto de ebullición: 2850 °C.','Entre las aplicaciones en las que interviene el hidróxido de calcio se encuentran:
...
1 átomo de hidrógeno.
1 átomo de cloro.
1 átomos de oxígeno.','Las principales propiedades del ácido hipocloroso (HClO) son:

Masa molar: 86,90 g/mol.
Punto de fusión: -120,6 °C.
Punto de ebullición: 2.0°C.','Entre las características más importantes del ácido hipocloroso se encuentran:
...
Punto de ebullición: -112 °C.','Entre los principales usos en los que se encuentra presente el silano son:
...
3 átomos de oxígeno.','Las principales propiedades del ácido nítrico (HNO3) son:

Densidad: 1,5 g/cm3.
Masa molar: 63,012 g/mol.
Punto de fusión: -42 °C.
Punto de ebullición: 83 °C.','Entre las características más importantes del ácido nítrico se encuentran:
...
1 átomo de carbono.
1 átomo de hidrógeno.
3 átomos de cloro.','Las principales propiedades del triclorometano (CHCl3) son:

Masa molar: 119,37 g/mol.
Densidad: 1,48 g/cm3.
Punto de fusión: -63,5 ºC.
Punto de ebullición: 61,2 °C.','Entre los principales usos y aplicaciones del tricloruro de metilo (CHCl3) son:
...
Riesgos
La exposición prolongada al cloroformo puede causar dolencias y enfermedades como por ejemplo:
...
Punto de ebullición: 77ºC.','Entre las principales aplicaciones del tetracloruro de carbono se encuentran:
...
2 átomos de carbono.
4 átomos de hidrógeno.','Las principales propiedades del eteno (C2H4) son:

Densidad: 28,05 g/ml.
Masa molar: 28,05 g/mol.
Punto de fusión: -169 °C.
Punto de ebullición: -104 °C.','Entre las principales aplicaciones del eteno se encuentran:
...
1 átomo de nitrógeno.
2 átomos de oxígeno.','Las principales propiedades del dióxido de nitrógeno (NO2) son:
...
1 átomo de aluminio.
3 átomos de oxígeno.
3 átomos de hidrógeno.','Las principales propiedades del trihidroxido de aluminio Al(OH)3 son:

Densidad: 2,42 g/cm3.
Masa molar: 78,004 g/mol.
Punto de fusión: 300 °C.','Entre las aplicaciones en las que interviene el hidróxido alumínico se encuentran:
